...
public class HelloWorldClient {
    ...
    public static void main(String[] args) {
        if (args != null && args.length < 2) {
            ...
            edu.ufp.inf.sd.rmi.project.client.HelloWorldClient hwc=new edu.ufp.inf.sd.rmi.project.client.HelloWorldClient(args);
            //2. ============ Lookup service ============
            hwc.lookupService();
            //3. ============ Play with service ============
            hwc.playService();
    ...
    public HelloWorldClient(String args[]) {
        try {
            ...
            Logger.getLogger(edu.ufp.inf.sd.rmi.project.client.HelloWorldClient.class.getName()).log(Level.SEVERE, null, e);
        }
    }
