...
import edu.ufp.inf.sd.rmi.project.server.HelloWorldImpl;
import edu.ufp.inf.sd.rmi.project.server.HelloWorldRI;
...
public class HelloWorldServer {
    ...
    public static void main(String[] args) {
        //System.out.println("TOU AQUIIIIIIIIIIIIIIIIIIIIIIIIIIIII");
        if (args != null && args.length < 3) {
            ...
            //1. ============ Create Servant ============
            edu.ufp.inf.sd.rmi.project.server.HelloWorldServer hws = new edu.ufp.inf.sd.rmi.project.server.HelloWorldServer(args);
